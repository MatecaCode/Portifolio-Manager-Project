...
const RULES = [
  ...
  // home & utilities (Servicemac = the mortgage servicer)
  [/SERVICEMAC|MORTGAGE|RENT\b|ATMOS|TXU|RELIANT|GREEN MOUNTAIN|CITY OF|WATER UTIL|ELECTRIC|AT&T|SPECTRUM|FRONTIER|XFINITY|VERIZON|T-MOBILE|HOME DEPOT|LOWE'?S|STATE FARM|ALLSTATE|GEICO|PROGRESSIVE|HOA |INSURANCE/i, 'home'],
  ...
  // shopping (broad — keep late)
  [/AMAZON|AMZN|GROUPON|TARGET|BEST BUY|ETSY|EBAY|MACY|ROSS |MARSHALLS|TJ ?MAXX|NIKE|ADIDAS|SHEIN|TEMU|ALIEXPRESS|IKEA|FIVE BELOW|DOLLAR (TREE|GENERAL)|BARNES|GAMESTOP|SEPHORA|ULTA/i, 'shopping'],
]
